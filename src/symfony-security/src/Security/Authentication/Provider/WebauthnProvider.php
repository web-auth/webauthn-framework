...
namespace Webauthn\Security\Bundle\Security\Authentication\Provider;
...
use Webauthn\Security\Bundle\Model\CanHaveRegisteredSecurityDevices;
use Webauthn\Security\Bundle\Security\Authentication\Token\PreWebauthnToken;
