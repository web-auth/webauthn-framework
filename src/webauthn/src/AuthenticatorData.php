...
{
    final public const int FLAG_UP = 0b00000001;

    final public const int FLAG_RFU1 = 0b00000010;

    final public const int FLAG_UV = 0b00000100;

    final public const int FLAG_BE = 0b00001000;

    final public const int FLAG_BS = 0b00010000;

    /**
     * TODO: remove bits 3 and 4 as they have been assigned to BE and BS in Webauthn level 3.
     */
    final public const int FLAG_RFU2 = 0b00111000;

    final public const int FLAG_AT = 0b01000000;
