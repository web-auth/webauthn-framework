...
class W10Test extends AbstractTestCase
{
    ...
    public function anAttestationWithTokenBindingCanBeVerified(): void
    {
        ...
        $credentialRepository->has(base64_decode('WsVEgVplFhLkRd68yW3KAIyVJ90ZsQOHFjnL71YirSY=', true))->willReturn(false);
    ...
    public function anAssertionCanBeVerified(): void
    {
        ...
        $credentialRepository = $this->prophesize(CredentialRepository::class);
        $credentialRepository->has(base64_decode('6oRgydKXdC3LtZBDoAXxKnWte68elEQejDrYOV9x+18=', true))->willReturn(true);
        $credentialRepository->getUserHandleFor(base64_decode('6oRgydKXdC3LtZBDoAXxKnWte68elEQejDrYOV9x+18=', true))->willReturn('ee13d4f1-4863-47dd-a407-097cb49ac822');
        $credentialRepository->get(base64_decode('6oRgydKXdC3LtZBDoAXxKnWte68elEQejDrYOV9x+18=', true))->willReturn(
        ...
        $credentialRepository->getCounterFor(base64_decode('6oRgydKXdC3LtZBDoAXxKnWte68elEQejDrYOV9x+18=', true))->willReturn(0);
        $credentialRepository->updateCounterFor(base64_decode('6oRgydKXdC3LtZBDoAXxKnWte68elEQejDrYOV9x+18=', true), Argument::any())->shouldBeCalled();
