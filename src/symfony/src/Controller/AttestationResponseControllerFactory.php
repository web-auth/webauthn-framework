...
final class AttestationResponseControllerFactory
{
    ...
    public function createAttestationRequestController(UserEntityGuesser $userEntityGuesser, string $profile, OptionsStorage $optionStorage): AttestationRequestController
    {
    ...
    public function createAttestationResponseController(OptionsStorage $optionStorage): AttestationResponseController
    {
