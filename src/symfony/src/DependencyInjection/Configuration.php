...
final class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->defaultValue(DefaultCreationOptionsHandler::class)->end()
            ->end()
            ->end()
            ->end()
            ->end()
    ...
    private function appendTokenTransportBinding(ArrayNodeDefinition $node): void
    {
        $node->children()
            ...
            ->info(
                'The name of the profile. Should be one of the creation profiles registered at path "webauthn.creation_profiles"'
            )
            ->isRequired()
            ->end()
