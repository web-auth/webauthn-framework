        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('metadata_service')
                    ->info('This feature is EXPERIMENTAL as the related specifications are not approved. Use with caution.')
                    ->canBeEnabled()
                    ->children()
                        ->scalarNode('http_client')
                            ->isRequired()
                        ...
                        ->scalarNode('token')
                            ->isRequired()
                            ->info('Access token for the FIDO Alliance Metadata Service (MDS). See https://fidoalliance.org/metadata/.')
                        ->end()
                        ->scalarNode('caching_service')
                            ->defaultNull()
                            ->info('Optional PSR-6 caching service.')
                        ->end()
                    ->end()
                ->end()
