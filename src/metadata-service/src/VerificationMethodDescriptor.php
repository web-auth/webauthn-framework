...
class VerificationMethodDescriptor implements JsonSerializable
{
    ...
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_PRESENCE);
    }

    public function fingerprint(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_FINGERPRINT);
    }

    public function passcode(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_PASSCODE);
    }

    public function voicePrint(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_VOICE_PRINT);
    }

    public function facePrint(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_FACE_PRINT);
    }

    public function location(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_LOCATION);
    }

    public function eyePrint(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_EYE_PRINT);
    }

    public function pattern(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_PATTERN);
    }

    public function handprint(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_HAND_PRINT);
    }

    public function none(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_NONE);
    }

    public function all(): bool
    {
        return 0 !== ($this->userVerification & VerificationMethodDescriptor::USER_VERIFY_ALL);
    }
