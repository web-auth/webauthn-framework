...
class MetadataStatement implements JsonSerializable
{
    ...
    final public const string KEY_PROTECTION_SOFTWARE = 'software';

    final public const int KEY_PROTECTION_SOFTWARE_INT = 0x0001;

    final public const string KEY_PROTECTION_HARDWARE = 'hardware';

    final public const int KEY_PROTECTION_HARDWARE_INT = 0x0002;

    final public const string KEY_PROTECTION_TEE = 'tee';

    final public const int KEY_PROTECTION_TEE_INT = 0x0004;

    final public const string KEY_PROTECTION_SECURE_ELEMENT = 'secure_element';

    final public const int KEY_PROTECTION_SECURE_ELEMENT_INT = 0x0008;
    ...
    final public const array KEY_PROTECTION_TYPES = [
    ...
    final public const array KEY_PROTECTION_TYPES_INT = [
    ...
    final public const string MATCHER_PROTECTION_SOFTWARE = 'software';

    final public const int MATCHER_PROTECTION_SOFTWARE_INT = 0x0001;

    final public const string MATCHER_PROTECTION_TEE = 'tee';

    final public const int MATCHER_PROTECTION_TEE_INT = 0x0002;

    final public const string MATCHER_PROTECTION_ON_CHIP = 'on_chip';

    final public const int MATCHER_PROTECTION_ON_CHIP_INT = 0x0004;

    final public const array MATCHER_PROTECTION_TYPES = [
        self::MATCHER_PROTECTION_SOFTWARE,
        self::MATCHER_PROTECTION_TEE,
        self::MATCHER_PROTECTION_ON_CHIP,
    ];

    final public const array MATCHER_PROTECTION_TYPES_INT = [
        self::MATCHER_PROTECTION_SOFTWARE_INT,
        self::MATCHER_PROTECTION_TEE_INT,
        self::MATCHER_PROTECTION_ON_CHIP_INT,
    ];

    final public const string ATTACHMENT_HINT_INTERNAL = 'internal';

    final public const string ATTACHMENT_HINT_EXTERNAL = 'external';

    final public const string ATTACHMENT_HINT_WIRED = 'wired';

    final public const string ATTACHMENT_HINT_WIRELESS = 'wireless';

    final public const string ATTACHMENT_HINT_NFC = 'nfc';

    final public const string ATTACHMENT_HINT_BLUETOOTH = 'bluetooth';

    final public const string ATTACHMENT_HINT_NETWORK = 'network';

    final public const string ATTACHMENT_HINT_READY = 'ready';

    final public const string ATTACHMENT_HINT_WIFI_DIRECT = 'wifi_direct';

    final public const string TRANSACTION_CONFIRMATION_DISPLAY_ANY = 'any';

    final public const string TRANSACTION_CONFIRMATION_DISPLAY_PRIVILEGED_SOFTWARE = 'privileged_software';

    final public const string TRANSACTION_CONFIRMATION_DISPLAY_TEE = 'tee';

    final public const string TRANSACTION_CONFIRMATION_DISPLAY_HARDWARE = 'hardware';

    final public const string TRANSACTION_CONFIRMATION_DISPLAY_REMOTE = 'remote';

    final public const string ALG_SIGN_SECP256R1_ECDSA_SHA256_RAW = 'secp256r1_ecdsa_sha256_raw';

    final public const string ALG_SIGN_SECP256R1_ECDSA_SHA256_DER = 'secp256r1_ecdsa_sha256_der';

    final public const string ALG_SIGN_RSASSA_PSS_SHA256_RAW = 'rsassa_pss_sha256_raw';

    final public const string ALG_SIGN_RSASSA_PSS_SHA256_DER = 'rsassa_pss_sha256_der';

    final public const string ALG_SIGN_SECP256K1_ECDSA_SHA256_RAW = 'secp256k1_ecdsa_sha256_raw';

    final public const string ALG_SIGN_SECP256K1_ECDSA_SHA256_DER = 'secp256k1_ecdsa_sha256_der';

    final public const string ALG_SIGN_SM2_SM3_RAW = 'sm2_sm3_raw';

    final public const string ALG_SIGN_RSA_EMSA_PKCS1_SHA256_RAW = 'rsa_emsa_pkcs1_sha256_raw';

    final public const string ALG_SIGN_RSA_EMSA_PKCS1_SHA256_DER = 'rsa_emsa_pkcs1_sha256_der';

    final public const string ALG_SIGN_RSASSA_PSS_SHA384_RAW = 'rsassa_pss_sha384_raw';

    final public const string ALG_SIGN_RSASSA_PSS_SHA512_RAW = 'rsassa_pss_sha256_raw';

    final public const string ALG_SIGN_RSASSA_PKCSV15_SHA256_RAW = 'rsassa_pkcsv15_sha256_raw';

    final public const string ALG_SIGN_RSASSA_PKCSV15_SHA384_RAW = 'rsassa_pkcsv15_sha384_raw';

    final public const string ALG_SIGN_RSASSA_PKCSV15_SHA512_RAW = 'rsassa_pkcsv15_sha512_raw';

    final public const string ALG_SIGN_RSASSA_PKCSV15_SHA1_RAW = 'rsassa_pkcsv15_sha1_raw';

    final public const string ALG_SIGN_SECP384R1_ECDSA_SHA384_RAW = 'secp384r1_ecdsa_sha384_raw';

    final public const string ALG_SIGN_SECP521R1_ECDSA_SHA512_RAW = 'secp512r1_ecdsa_sha256_raw';

    final public const string ALG_SIGN_ED25519_EDDSA_SHA256_RAW = 'ed25519_eddsa_sha512_raw';

    final public const string ALG_KEY_ECC_X962_RAW = 'ecc_x962_raw';

    final public const string ALG_KEY_ECC_X962_DER = 'ecc_x962_der';

    final public const string ALG_KEY_RSA_2048_RAW = 'rsa_2048_raw';

    final public const string ALG_KEY_RSA_2048_DER = 'rsa_2048_der';

    final public const string ALG_KEY_COSE = 'cose';

    final public const string ATTESTATION_BASIC_FULL = 'basic_full';

    final public const string ATTESTATION_BASIC_SURROGATE = 'basic_surrogate';

    final public const string ATTESTATION_ATTCA = 'attca';

    final public const string ATTESTATION_ANONCA = 'anonca';
