...
class MetadataService
{
    ...
    public function getMetadataStatementFor(MetadataTOCPayloadEntryInterface $entry, string $hashingFunction = 'sha256'): MetadataStatementInterface
    {
    ...
    public function getMetadataTOCPayload(): MetadataTOCPayloadInterface
    {
