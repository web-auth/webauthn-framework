...
final class AndroidSafetyNetAttestationStatementTest extends AbstractTestCase
{
    ...
    public function anAndroidSafetyNetAttestationCanBeVerified(): void
    {
        ...
        $this->clock->set((new DateTimeImmutable())->setTimestamp(1_548_489_000));

        static::assertInstanceOf(AuthenticatorAttestationResponse::class, $publicKeyCredential->response);
        $this->client->setResponseFactory(new MockResponse(
        ...
        // Then
        static::assertSame('b93fd961-f2e6-462f-b122-82002247de78', $pkSource->aaguid->toRfc4122());
    }
}
