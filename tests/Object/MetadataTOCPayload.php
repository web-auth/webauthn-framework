...
namespace Webauthn\Tests\Object;
...
class MetadataTOCPayload implements MetadataTOCPayloadInterface
{
    ...
    /**
     * @var MetadataTOCPayloadEntryInterface[]
     */
    private $entries = [];
    ...
    public function addEntry(MetadataTOCPayloadEntryInterface $entry): MetadataTOCPayloadInterface
    {
        $this->entries[] = $entry;
    ...
    public function jsonSerialize(): array
    {
        $data = [
            ...
            'no' => $this->no,
            'entries' => array_map(static function (MetadataTOCPayloadEntryInterface $object): array {
