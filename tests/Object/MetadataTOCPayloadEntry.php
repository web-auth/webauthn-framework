...
class MetadataTOCPayloadEntry implements MetadataTOCPayloadEntryInterface
{
    ...
    public function addStatusReports(StatusReportInterface $statusReport): MetadataTOCPayloadEntryInterface
    {
    ...
    public function jsonSerialize(): array
    {
        $data = [
            ...
            'url' => $this->url,
            'statusReports' => array_map(static function (StatusReportInterface $object): array {
